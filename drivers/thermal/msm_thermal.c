...
static struct cpus {
	...
	.throttling = false,
	.thermal_steps = {702000, 1026000, 1350000, 1458000},
...
static void check_temp(struct work_struct *work)
{
    ...
    for (i = 0; i < TSENS_MAX_SENSORS; i++) {
		...
		pr_info("%s: Temp: %ld Sensor: %d\n",
					KBUILD_MODNAME, temp, tsens_dev.sensor_num);
	}
	...
	*/
	...
	/*
	pr_info("%s: Temp: %ld Threshold: %d Sensor: %d\n",
				KBUILD_MODNAME, temp, temp_threshold, tsens_dev.sensor_num);
	*/
