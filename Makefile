...
CFLAGS_MODULE   = -DMODULE -marm -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4 -mvectorize-with-neon-quad
AFLAGS_MODULE   = -DMODULE -marm -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4 -mvectorize-with-neon-quad
LDFLAGS_MODULE  =
